...
mini_options = {'Emoji_Data':['Cupcake','Truly'],
...
app_table = html.Div([html.Div(id='legend_id', style={'float': 'right'}),
    ...
    ),dcc.Store(id='stored-diff'),dcc.Store(id='stored-emoji'),dcc.Store(id='stored-emotion')
])
...
app_upload = html.Div([
    dcc.Markdown(
                ...
                html.Div([
                    ...
                    dcc.Upload(html.Div(['Drag and Drop or ', html.A('Select a File')]), 
                    style={
                        'width': '65%',
                        'height': '60px',
                        'lineHeight': '60px',
                        ...
                        'borderStyle': 'dashed',
                        'borderRadius': '5px',
                        'textAlign': 'center'}, id = 'upload_emotion_data',multiple=False),
                    html.Hr(),
                    dbc.Button("Analyze Data",id="submit-button",color = "primary",outline=True, className="mr-2", n_clicks=0)
                ]), 
                ...
                dbc.Col(
                    dbc.FormGroup(
                        [
                           ...
                           #Adding Dropdown for selecting Sections.
                dcc.Dropdown(id ='data_id',
                options=[
                    {'label': name, 'value': name } for name in  mini_names],
                    value = list(mini_options.keys())[0], searchable = False,
    ...
    [
        dbc.Tabs(
            [   dbc.Tab(
                ...
                ), label="Uploads", style={"padding": "10px"}),
                
                dbc.Tab(app_graphs, label="Graphs", style={"padding": "10px"},),
        ...
        [
            ...
            dbc.Row(
                [
                    ...
                    dbc.Col(layout_app,width = 9, md=8, sm=12,),   
                ],
                id="layout",
